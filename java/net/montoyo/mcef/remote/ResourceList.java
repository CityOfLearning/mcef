...
/**
 * An {@link java.util.ArrayList} extended with utility functions for
 * {@link Resource}
 *
 * @author montoyo
 *
...
public class ResourceList extends ArrayList<Resource> {
	...
	/**
	 * Checks if every resources exists. If they exists and if their checksum
	 * are matching, they are removed from the list.
	 */
