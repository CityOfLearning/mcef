...
public interface CefContextMenuParams {
	...
	public static final class TypeFlags {
		...
		public final static int CM_TYPEFLAG_PAGE = 1 << 0; // !< The top page is
															// selected.
		public final static int CM_TYPEFLAG_FRAME = 1 << 1; // !< A subframe
															// page is selected.
		public final static int CM_TYPEFLAG_LINK = 1 << 2; // !< A link is
															// selected.
		public final static int CM_TYPEFLAG_MEDIA = 1 << 3; // !< A media node
															// is selected.
		public final static int CM_TYPEFLAG_SELECTION = 1 << 4; // !< There is a
																// textual or
																// mixed
																// selection
																// that is
																// selected.
		public final static int CM_TYPEFLAG_EDITABLE = 1 << 5; // !< An editable
																// element is
																// selected.
	}
	 ...
	 * any, that the context menu was invoked on. See EditStateFlags for
	 * possible values.
	 */
	 ...
	 * any, that the context menu was invoked on. See MediaStateFlags for
	 * possible values.
	 */
	...
	/**
	 * Returns the text of the misspelled word, if any, that the context menu
	 * was invoked on.
	 */
