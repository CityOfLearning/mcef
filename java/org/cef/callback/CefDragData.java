...
/**
 * Class used to represent drag data. The methods of this class may be called on
 * any thread.
 */
public abstract class CefDragData {
	 ...
	 * NULL this method will return the size of the file contents in bytes. Call
	 ...
	 * CefBrowser.dragTargetDragEnter as the web view does not allow us to drag
	 ...
	 *
	 * @param text
	 *            The plain text fragment to be set.
	 */
	 ...
	 *
	 * @param title
	 *            The tile associated with the link.
	 */
	 ...
	 *
	 * @param url
	 *            The link URL to be set.
	 */
	public abstract void setLinkURL(String url);

	@Override
	public String toString() {
		return "CefDragData [isReadOnly()=" + isReadOnly() + ", isLink()=" + isLink() + ", isFragment()=" + isFragment()
				+ ", isFile()=" + isFile() + ", getLinkURL()=" + getLinkURL() + ", getLinkTitle()=" + getLinkTitle()
				+ ", getLinkMetadata()=" + getLinkMetadata() + ", getFragmentText()=" + getFragmentText()
				+ ", getFragmentHtml()=" + getFragmentHtml() + ", getFragmentBaseURL()=" + getFragmentBaseURL()
