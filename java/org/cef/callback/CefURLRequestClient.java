...
/**
 * Interface that should be implemented by the CefURLRequest client. The methods
 * of this class will be called on the same thread that created the request
...
public interface CefURLRequestClient extends CefNative {
	...
	/**
	 * Called when some part of the response is read. |data| contains the
	 * current bytes received since the last call. This method will not be
