...
public interface CefContextMenuHandler {
	 ...
	 * @param model
	 *            can be cleared to show no context menu or modified to show a
	 *            custom menu.
	 */
	...
	/**
	 * Called when the context menu is dismissed irregardless of whether the
	 * menu was empty or a command was selected.
	 *
	 * @param browser
	 *            The corresponding browser.
	 */
