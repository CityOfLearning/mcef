...
public interface CefRenderHandler {
	 ...
	 * CefBrowser.dragSourceEndedAt and CefBrowser.ragSourceSystemDragEnded
	 * either synchronously or asynchronously to inform the web view that the
	 ...
	 * @param y
	 *            Coordinate within CefBrowser
	 * @return false to abort the drag operation or true to handle the drag
	 *         operation.
	 */
