...
public interface CefResourceHandler extends CefNative {
	 ...
	 * otherwise. If false is returned for any cookie then no cookies will be
	 ...
	 * returns false. If the response length is known set |response_length| to a
	 * positive value and ReadResponse() will be called until it returns false
	 ...
	 * header information is available immediately). To cancel the request
	 * return false.
	 */
