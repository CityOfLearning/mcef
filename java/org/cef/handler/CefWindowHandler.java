...
public interface CefWindowHandler {
	 ...
	 *
	 * The method is called in case of the following events: MOUSE_MOVED,
	 * MOUSE_PRESSED, MOUSE_RELEASED and MOUSE_WHEEL for a horizontal wheel
	 * movement.
	 *
	 * @param browser
	 *            The browser generating the event.
	 ...
	 * @param button
	 *            An integer indicating which mouse button state changed. If
	 *            parameter event is set to MouseEvent.MOUSE_WHEEL, the value of
	 *            this parameter specifies the rotation indicator (negative
	 *            value for left scroll and positive value for right scroll).
	 */
