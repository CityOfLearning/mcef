...
JNIEXPORT void JNICALL Java_org_cef_CefApp_N_1SetClassLoader(JNIEnv *env, jobject, jobject cl)
{
	//montoyo: I added this method to fix FML's classloader bs.
	SetJavaClassLoader(env, cl);
}
