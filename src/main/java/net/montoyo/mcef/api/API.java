...
public interface API {
	 ...
	 * @param transp
	 *            True is the web view can be transparent
	 * @return The created web view, or null if this is run on server.
	 */
	public IBrowser createBrowser(String url, boolean transp);

	/**
	 * Call this to know if MCEF is in virtual mode. MCEF switches in virtual
	 * mode if something failed to load. When in virtual mode, createBrowser()
	 * will generate fake browsers that does nothing.
	 *
	 ...
	 *
	 * @param idh
	 *            The display handler to register.
	 * @see IDisplayHandler
	 */
	 ...
	 *
	 * @param iqh
	 *            The JavaScript query handler to register.
	 * @see IJSQueryHandler
	 */
