...
public interface IBrowser {
	 ...
	 *
	 * @param x1
	 *            The first X coord of the rectangle to render the web view on
	 *            (left).
	 * @param y1
	 *            The first Y coord of the rectangle to render the web view on
	 *            (top).
	 * @param x2
	 *            The second X coord of the rectangle to render the web view on
	 *            (right).
	 * @param y2
	 *            The second Y coord of the rectangle to render the web view on
	 *            (bottom).
	 */
	 ...
	 *
	 * @param c
	 *            The pressed key's character.
	 * @param mods
	 *            The key modifiers (shift, ctrl, alt)
	 */
	 ...
	 *
	 * @param x
	 *            The X coord of the mouse.
	 * @param y
	 *            The Y coord of the mouse.
	 * @param mods
	 *            The key modifiers (shift, ctrl, alt)
	 * @param btn
	 *            The mouse button to press. See
	 *            {@link java.awt.event.MouseEvent}
	 * @param pressed
	 *            true if the button is pressed, false if it is released.
	 * @param ccnt
	 *            The click count. You probably want this to be 1.
	 */
	 ...
	 *            The key modifiers (shift, ctrl, alt)
	 * @param left
	 *            true if the mouse is out of (left) the web view.
	 */
	 ...
	 * @param rot
	 *            The number of "clicks" by which the mouse wheel was rotated.
	 */
	 ...
	 *            The script to run.
	 * @param frame
	 *            The URL of the frame to run the script on. Let this empty for
	 *            the default frame.
	 */
	public void runJS(String script, String frame);

	/**
	 * Asynchronously retrieves the current page's source code. FIXME: This is
	 * asynchronous; so you won't get your source right after calling this
	 * method!
	 *
	 * @param isv
	 *            An object that handles strings.
	 */
