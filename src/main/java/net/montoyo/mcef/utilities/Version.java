...
/**
 * A utility class used for parsing decimal dot-separated versions from strings
 * and comparing them. Example: 5.4.9
 *
 * @author montoyo
 *
 */
public class Version {
	 ...
	 *
	 * @param v
	 *            A version string, such as 5.4.9
	 */
	...
	/**
	 * Compares two versions. Return true if this instance is bigger than v. If
	 * both describes the same version, false is returned.
	 *
	 * @param v
	 *            The version to compare with.
