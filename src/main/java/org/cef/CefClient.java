...
public class CefClient extends CefClientHandler implements CefContextMenuHandler, CefDialogHandler, CefDisplayHandler,
		CefDownloadHandler, CefDragHandler, CefFocusHandler, CefGeolocationHandler, CefJSDialogHandler,
		CefKeyboardHandler, CefLifeSpanHandler, CefLoadHandler, CefRenderHandler, CefRequestHandler, CefWindowHandler {
	...
	/**
	 * The CTOR is only accessible within this package. Use
	 * CefApp.createClient() to create an instance of this class.
	 *
	...
	public boolean onJSDialog(CefBrowser browser, String origin_url, String accept_lang, JSDialogType dialog_type,
		...
		if ((jsDialogHandler_ != null) && (browser != null)) {
			return jsDialogHandler_.onJSDialog(browser, origin_url, accept_lang, dialog_type, message_text,
	...
	public boolean onSetFocus(final CefBrowser browser, FocusSource source) {
		...
		if (!alreadyHandled) {
			Runnable r = () -> browser.getUIComponent().requestFocus();
