...
public interface CefBrowser {
	...
	/**
	 * Execute a string of JavaScript code in this frame. The url parameter is
	 * the URL where the script in question can be found, if any. The renderer
	 * may request this URL to show the developer the source of the error. The
	 * line parameter is the base line number to use for error reporting.
	 *
	 * @param code
	 ...
	 *            to be searched for.
	 * @param forward
	 *            indicates whether to search forward or backward within the
	 *            page.
	 * @param matchCase
	...
	/**
	 * Get an instance of the dev tools to be displayed in its own window or to
	 * be embedded within your UI. Only one instance per browser is available.
	 */
	...
	/**
	 * Load the contents of val with the specified dummy url. url should have a
	 * standard scheme (for example, http scheme) or behaviors like link clicks
	 * and web security restrictions may not behave as expected.
	 *
	 * @param val
	 *            Content to be displayed.
	 * @param url
	 *            dummy url to be used for.
	 */
	 ...
	 * be pending at any given time.The dialog will be initiated asynchronously
	 * on the UI thread.
	 *
	 * @param mode
	 ...
	 *            is the path with optional directory and/or file name component
	 *            that should be initially selected in the dialog.
	 * @param acceptFilters
	 *            are used to restrict the selectable file types and may any
	 *            combination of (a) valid lower-cased MIME types (e.g. "text/*"
	 *            or "image/*"), (b) individual file extensions (e.g. ".txt" or
	 *            ".png"), or (c) combined description and file extension
	 *            delimited using "|" and ";" (e.g. "Image Types|.png;.gif;.jpg"
	 *            ).
	 * @param selectedAcceptFilter
	 *            is the 0-based index of the filter that should be selected by
	 *            default.
	 * @param callback
	 *            will be executed after the dialog is dismissed or immediately
	 *            if another dialog is already pending.
	 */
