...
public interface CefBrowser {
	 ...
	 *            the default file name to select in the dialog.
	 * @param acceptTypes
	 *            is a list of valid lower-cased MIME types or file extensions
	 *            specified in an input element and is used to restrict
