	...
	private CefWindowHandlerAdapter win_handler_ = new CefWindowHandlerAdapter() {
		...
		public void onMouseEvent(CefBrowser browser, int event, final int screenX, final int screenY,
			...
			SwingUtilities.invokeLater(() -> {
				// Send mouse event to the root UI component instead to the
				// browser UI.
				// Otherwise no mouse-entered and no mouse-exited events
				// would be fired.
				...
				// Always fire a mouse-clicked event after a mouse-released
				// event.
