...
class CefMenuModel_N extends CefNativeAdapter implements CefMenuModel {
	...
	@Override
	public boolean getAccelerator(int command_id, IntRef key_code, BoolRef shift_pressed, BoolRef ctrl_pressed,
			BoolRef alt_pressed) {
		try {
	...
	@Override
	public boolean getAcceleratorAt(int index, IntRef key_code, BoolRef shift_pressed, BoolRef ctrl_pressed,
			BoolRef alt_pressed) {
		try {
	...
	private final native boolean N_GetAccelerator(int command_id, IntRef key_code, BoolRef shift_pressed,
			BoolRef ctrl_pressed, BoolRef alt_pressed);

	private final native boolean N_GetAcceleratorAt(int index, IntRef key_code, BoolRef shift_pressed,
			BoolRef ctrl_pressed, BoolRef alt_pressed);
	...
	private final native boolean N_SetAccelerator(int command_id, int key_code, boolean shift_pressed,
	...
	@Override
	public boolean setAccelerator(int command_id, int key_code, boolean shift_pressed, boolean ctrl_pressed,
			boolean alt_pressed) {
		try {
	...
	@Override
	public boolean setAcceleratorAt(int index, int key_code, boolean shift_pressed, boolean ctrl_pressed,
			boolean alt_pressed) {
		try {
