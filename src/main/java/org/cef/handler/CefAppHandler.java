...
public interface CefAppHandler {
	 ...
	 * empty for the browser process. Be cautious when using this method to
	 * modify command-line arguments for non-browser processes as this may
	 ...
	 * false. If you want to abort the terminate or if you want to implement
	 * your own shutdown sequence return true and do the cleanup on your own.
	 *
	...
	/**
	 * Implement this method to get state changes of the CefApp. See
	 * {@link CefAppState} for a complete list of possible states.
	 *
