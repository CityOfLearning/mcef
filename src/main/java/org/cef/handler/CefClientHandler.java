...
public abstract class CefClientHandler implements CefNative {
	...
	/**
	 * Return the handler for browser display state events. This method is a
	 * callback method and is called by the native code.
	 */
	abstract protected CefDisplayHandler getDisplayHandler();

	/**
	 * Return the handler for download events. This method is a callback method
	 * and is called by the native code.
	 */
	abstract protected CefDownloadHandler getDownloadHandler();

	/**
	 * Return the handler for drag events. This method is a callback method and
	 * is called by the native code.
	 */
	abstract protected CefDragHandler getDragHandler();

	/**
	 * Return the handler for focus events. This method is a callback method and
	 * is called by the native code.
	 */
	abstract protected CefFocusHandler getFocusHandler();

	/**
	 * Return the handler for geolocation requests. This method is a callback
	 * method and is called by the native code.
	 */
	abstract protected CefGeolocationHandler getGeolocationHandler();

	/**
	 * Return the handler for javascript dialog requests. This method is a
	 * callback method and is called by the native code.
	 */
	abstract protected CefJSDialogHandler getJSDialogHandler();

	/**
	 * Return the handler for keyboard events. This method is a callback method
	 * and is called by the native code.
	 */
	abstract protected CefKeyboardHandler getKeyboardHandler();

	/**
	 * Return the handler for browser life span events. This method is a
	 * callback method and is called by the native code.
	 */
	abstract protected CefLifeSpanHandler getLifeSpanHandler();

	/**
	 * Return the handler for browser load status events. This method is a
	 * callback method and is called by the native code.
	 */
	...
	/**
	 * Return the handler for off-screen rendering events. This method is a
	 * callback method and is called by the native code.
	 */
	abstract protected CefRenderHandler getRenderHandler();

	/**
	 * Return the handler for browser request events. This method is a callback
	 * method and is called by the native code.
	 */
	abstract protected CefRequestHandler getRequestHandler();

	/**
	 * Return the handler for windowed rendering events. This method is a
	 * callback method and is called by the native code.
	 */
