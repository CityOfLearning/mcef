...
public interface CefDownloadHandler {
	/**
	 * Called before a download begins. By default the download will be
	 * canceled. Execute callback either asynchronously or in this method to
	 * continue the download if desired.
	 *
	 * @param browser
	 *            The desired browser.
	 * @param downloadItem
	 *            The item to be downloaded. Do not keep a reference to it
	 *            outside this method.
	 * @param suggestedName
