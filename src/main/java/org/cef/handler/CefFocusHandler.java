...
public interface CefFocusHandler {
	 ...
	 */
	enum FocusSource {
		FOCUS_SOURCE_NAVIGATION, // !< The source is explicit navigation via the
									// API (LoadURL(), etc).
	 ...
	 *            The browser generating the event.
	 * @param next
	 *            will be true if the browser is giving focus to the next
	 *            component and false if the browser is giving focus to the
	 *            previous component.
	 */
