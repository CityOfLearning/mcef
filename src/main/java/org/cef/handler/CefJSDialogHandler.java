...
public interface CefJSDialogHandler {
	 ...
	 * @return false to use the default dialog implementation. Return true if
	 *         the application will use a custom dialog.
	 */
	 ...
	 * to immediately executing the callback as this is used to detect
	 * presumably malicious behavior like spamming alert messages in
	 * onbeforeunload). Set suppress_message to false and return false to use
	 * the default implementation (the default implementation will show one
	 * modal dialog at a time and suppress any additional dialog requests until
	 * the displayed dialog is dismissed). Return true if the application will
	 * use a custom dialog or if the callback has been executed immediately.
	 * Custom dialogs may be either modal or modeless. If a custom dialog is
	 * used the application must execute callback once the custom dialog is
	 * dismissed.
	 *
	 * @param browser
	 *            The corresponding browser.
	 ...
	 * @param callback
	 *            execute callback once the custom dialog is dismissed.
	 * @param suppress_message
	 *            set to true to suppress displaying the message.
	 * @return false to use the default dialog implementation. Return true if
	 *         the application will use a custom dialog.
	 */
	public boolean onJSDialog(CefBrowser browser, String origin_url, String accept_lang, JSDialogType dialog_type,
