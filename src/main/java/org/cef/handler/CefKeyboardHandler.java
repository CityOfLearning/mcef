...
public interface CefKeyboardHandler {
	...
	public static final class CefKeyEvent {
		...
		public static enum EventType {
			...
			/**
			 * Notification that a character was typed. Use this for text input.
			 * Key down events may generate 0, 1, or more than one character
		 ...
		 * details). This value will always be false on non-Windows platforms.
		 */
		...
		/**
		 * True if the focus is currently on an editable field on the page. This
		 * is useful for determining if standard key events should be
		 * intercepted.
		 */
		public final boolean focus_on_editable_field;

		CefKeyEvent(EventType typeAttr, int modifiersAttr, int windows_key_codeAttr, int native_key_codeAttr,
				boolean is_system_keyAttr, char characterAttr, char unmodified_characterAttr,
		...
		public String toString() {
			return "CefKeyEvent [type=" + type + ", modifiers=" + modifiers + ", windows_key_code=" + windows_key_code
					+ ", native_key_code=" + native_key_code + ", is_system_key=" + is_system_key + ", character="
					+ character + ", unmodified_character=" + unmodified_character + ", focus_on_editable_field="
	 ...
	 * @param event
	 *            contains information about the keyboard event.
	 * @param is_keyboard_shortcut
	 *            set to true and return false, if the event will be handled in
	 *            OnKeyEvent() as a keyboard shortcut.
