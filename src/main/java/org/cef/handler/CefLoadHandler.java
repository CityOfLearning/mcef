...
public interface CefLoadHandler {
	...
	/**
	 * Called when the browser is done loading a frame. The frameIdentifer value
	 * will never be empty. Multiple frames may be loading at the same time.
	 * Sub-frames may start or continue loading after the main frame load has
	 * ended. This method will always be called for all frames irrespective of
	 * whether the request completes successfully.
	 *
	 * @param browser
	 *            The affected browser.
	 * @param frameIdentifer
	 *            The identifier of the loading frame.
	 ...
	 * twice -- once when loading is initiated either programmatically or by
	 * user action, and once when loading is terminated due to completion,
	 * cancellation of failure.
	 *
	 * @param browser
	 *            The affected browser.
	 * @param isLoading
	...
	/**
	 * Called when the browser begins loading a frame. The frameIdentifer value
	 * will never be empty. Multiple frames may be loading at the same time.
	 * Sub-frames may start or continue loading after the main frame load has
	 * ended. This method may not be called for a particular frame if the load
	 * request for that frame fails. For notification of overall browser load
