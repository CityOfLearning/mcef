...
public interface CefMessageRouterHandler extends CefNative {
	 ...
	 *         registered handlers, if any. If no handlers return true from this
	 *         method then the query will be automatically canceled with an
	 *         error code of -1 delivered to the JavaScript onFailure callback.
	 */
