...
public interface CefRequestContextHandler {
	 ...
	 * @param top_origin_url
	 *            is the URL for the top-level frame that contains the plugin
	 *            when loading a specific plugin instance or empty when building
	 *            the initial list of enabled plugins for 'navigator.plugins'
	 *            JavaScript state.
	 * @param plugin_info
	 *            includes additional information about the plugin that will be
	 *            loaded. |plugin_policy| is the recommended policy.
	 * @return true to block loading of the plugin.
	 */
	boolean onBeforePluginLoad(String mime_type, String plugin_url, String top_origin_url,
