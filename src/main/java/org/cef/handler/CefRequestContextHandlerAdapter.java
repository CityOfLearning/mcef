...
/**
 * An abstract adapter class for receiving browser request context events. The
...
public abstract class CefRequestContextHandlerAdapter implements CefRequestContextHandler {
	...
	@Override
	public boolean onBeforePluginLoad(String mime_type, String plugin_url, String top_origin_url,
