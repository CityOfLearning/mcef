...
public interface CefRequestHandler {
	 ...
	 */
	boolean getAuthCredentials(CefBrowser browser, boolean isProxy, String host, int port, String realm, String scheme,
			CefAuthCallback callback);

	/**
	 * Called on the IO thread before a resource is loaded. To allow the
	 * resource to load normally return NULL. To specify a handler for the
	 ...
	 * certificate. Return true and call CefAllowCertificateErrorCallback::
	 ...
	 * canceled automatically. If "ignore-certificate-errors" command-line
	 ...
	 * via the registered OS protocol handler, if any. SECURITY WARNING: YOU
