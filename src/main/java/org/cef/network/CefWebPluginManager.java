...
public abstract class CefWebPluginManager {
	...
	/**
	 * Add a plugin path (directory + file). This change may not take affect
	 * until after refreshPlugins() is called. Can be called on any thread in
	 * the browser process.
	 */
	...
	/**
	 * Register a plugin crash. Can be called on any thread in the browser
	 * process but will be executed on the IO thread.
	 */
	 ...
	 * until after CefRefreshWebPlugins() is called. Can be called on any thread
	 * in the browser process.
	 *
	 * @bug http://www.magpcss.org/ceforum/viewtopic.php?f=6&t=6149&p=21075&
	 *      hilit=CefRemoveWebPluginPath#p21075
	 */
	public abstract void removePlugin(String path);

	/**
	 * Unregister an internal plugin. This may be undone the next time
	 * CefRefreshWebPlugins() is called. Can be called on any thread in the
	 * browser process.
	 */
	 ...
	 *
	 * @param visitor
	 *            Called with plugin information when available.
	 */
